...
export const HorizontalPlaylists = (props: Props) => {
  ...
  return (React.createElement("div", { className: 'scroll-view' },
    ...
    React.createElement("button", { type: 'button', onClick: function () { return scroll('left'); }, className: 'left-arrow', style: { transform: 'rotate(180deg)' } }, "\u276F"),
    React.createElement("button", { type: 'button', onClick: function () { return scroll('right'); }, className: 'right-arrow' }, "\u276F")));
/*
  return (
