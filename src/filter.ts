    ...
    React.createElement("div", { className: "filter-container " + props.searchParams.get('filter') },
        React.createElement("div", { className: 'filter-type' },
            ...
            types.map(function (type) {
                return React.createElement("div", { key: Object.keys(type)[0], className: props.filter.type === Object.keys(type)[0] ? 'selected' : '', onClick: function () { return props.handleFilterType(Object.keys(type)[0] === props.filter.type ? 'any' : Object.keys(type)[0] as any); } },
        ...
        React.createElement("div", { className: 'filter-type' },
            ...
            durations.map(function (type) {
                return React.createElement("div", { key: Object.keys(type)[0], className: props.filter.duration === Object.keys(type)[0] ? 'selected' : '', onClick: function () { return props.handleFilterDuration(Object.keys(type)[0] === props.filter.duration ? 'any' : Object.keys(type)[0] as any); } },
                    (type as any)[Object.keys(type)[0]],
                    " ",
                    (type as any)[Object.keys(type)[0]],
                    " ",
        ...
        React.createElement("div", { className: 'filter-type' },
            ...
            orders.map(function (type) {
                return React.createElement("div", { key: Object.keys(type)[0], className: props.filter.order === Object.keys(type)[0] ? 'selected' : '', onClick: function () { return props.handleFilterOrder(Object.keys(type)[0] as any === props.filter.order ? 'relevance' : Object.keys(type)[0] as any); } },
                    (type as any)[Object.keys(type)[0]],
                    " ",
                    (type as any)[Object.keys(type)[0]],
                    " ",
